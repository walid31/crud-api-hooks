                ...
                {employees.map(employee => (
                    <div className="flex items-center bg-gray-100 mb-10 shadow" key={employee.id}>
                        <div className="flex-auto text-left px-4 py-2 m-2">
                            <p className="text-gray-900 leading-none">{'Name: ' + employee.employee_name}</p>
                            <p className="text-gray-600">{'Salary: ' + employee.employee_salary + ' DZD'}
                            </p>
                            <span className="inline-block text-sm font-semibold mt-1">{'Age: ' + employee.employee_age}</span>
                        </div>
